...
class BasicGRUModel(CaptionFrameModel):
    ...
    def buildModel(self, use_attention=False):
        ...
        if self.dropOutAtCaption is not None:
            ...
            cmodel_gru = GRU(512, return_sequences=True,kernel_initializer='random_normal', name='caption_gru') (cmodel_dropout)
        else:
            cmodel_gru = GRU(512, return_sequences=True,kernel_initializer='random_normal', name='caption_gru') (cmodel_dense)
        ...
        combined_model_gru = GRU(1024,return_sequences=True, kernel_initializer='random_normal',recurrent_regularizer=l2(0.01), name='final_gru') (combined_model_dropout)
