...
from tensorflow.keras.layers import LSTM, Dense, TimeDistributed, Dropout, BatchNormalization, Activation, Bidirectional, GRU, RepeatVector, Embedding
from tensorflow.keras.models import Model
from tensorflow.keras.backend import concatenate
from tensorflow.keras.regularizers import l2

def getModel(final_caption_length, embedding_dim, video_frame_shape, total_vocab_size, embedding_weights=None, dropOutAtFrame=0.2, dropOutAtCaption=None, dropOutAtFinal=0.2):
    ...
    if dropOutAtCaption is not None:
        cmodel_dropout = TimeDistributed(Dropout(dropOutAtCaption, name='caption_dropout')) (cmodel_dense)
    ...
    imodel_dropout = TimeDistributed(Dropout(dropOutAtFrame, name='frame_dropuout')) (imodel_dense)
    ...
    combined_model_dropout = TimeDistributed(Dropout(dropOutAtFinal, name='final_dropout')) (combined_model)
